...
var AppComponent = /** @class */ (function () {
    function AppComponent(service) {
        ...
        this.title = 'My QA Automation Test Site';
        this.username = "";
        this.password = "";
    }
    ...
    AppComponent.prototype.login = function () {
        var _this = this;
        setTimeout(function () {
            if (_this.username === 'user1' && _this.password === 'password1') {
                _this.loggedIn = true;
            }
            else {
                _this.denied = true;
...
var mockData = __webpack_require__(/*! ./mockData.json */ "./src/app/mockData.json");
var DataService = /** @class */ (function () {
    function DataService() {
    }
    DataService.prototype.fetch = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(mockData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["delay"])(3000));
    };
...
module.exports = {"message":"Here be some data that takes a while to load"};
...
module.exports = __webpack_require__(/*! /Users/louis/solirius/moj/interviews/ang-test/src/main.ts */"./src/main.ts");
